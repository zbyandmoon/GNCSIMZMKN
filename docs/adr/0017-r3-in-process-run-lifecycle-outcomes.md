...
5. 当前 RuntimeDiagnostic 保存稳定 code、stage、subject handle、RunId、tick/base epoch、cause code/ref、validity effect、`FailOperation` disposition 和静态 detail。execution failure 的 validity 为 `Invalid`，InitializationCommit 前失败为 `Unknown`。
