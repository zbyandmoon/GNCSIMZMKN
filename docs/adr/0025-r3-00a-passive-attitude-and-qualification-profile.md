...
12. Two real canonical Sessions reach tick 3000 with `3000` committed intervals and a `Completed / duration-complete` terminal result. Cadence counts are navigation `3001`, guidance `601`, controller `1501` and actuator `3001`; maximum `HeldLatest` ages remain `4/1`, and nonzero actuator output reaches an RK4 held form. The current clean-build query envelope is Mach `[0.30237994030302495,0.61764705882352944]`, alpha `[-3.1412239572488261,3.1397707600310416]` and beta `[-1.4925695311254403,1.4441212960610592]`; the last-bit alpha change remains inside the frozen independent tolerance. State, aggregate, terminal window, RunOutcome, envelope and cadence are bit-deterministic across both runs in one build/process. The compact difference report has `unresolved_count == 0` and emits `abstract_engineering_target_conformance` within the declared abstract-engineering claim. Real-aircraft accuracy, stability, handling quality and certification remain outside that claim.
